...
def main(argv=None):
    ...
    parser.add_argument("--config", type=Path, default=ROOT / "docs/stock_idea_pilot_config.json")
    parser.add_argument("--evaluation-plan", type=Path, default=ROOT / "docs/stock_idea_evaluation_plan.json")
